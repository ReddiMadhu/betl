...
export const allAssets: Asset[] = [
  ...
  { id: 'c3', name: 'Healthcare Claim Analysis Dashboard', technology: 'Tableau', businessArea: 'Claims', assetType: 'Dashboard', owner: 'Sarah Mitchell', sourceCount: 2, targetCount: 1, kpiCount: 8, lastUpdated: '2026-09-05', description: 'Comprehensive clinical healthcare claims evaluation, diagnostic categorization, benefit utilization, and regional cost distribution.' },
  ...
  { id: 'u5', name: 'Test', technology: 'Power BI', businessArea: 'Underwriting', assetType: 'Dashboard', owner: 'Michael Zhang', sourceCount: 6, targetCount: 1, kpiCount: 3, lastUpdated: '2026-08-20', description: 'Underwriting testing sandbox dashboard evaluating submission loss ratios and risk score distributions.' },
  { id: 'u6', name: 'FFQ_Test', technology: 'Power BI', businessArea: 'Underwriting', assetType: 'Dashboard', owner: 'Michael Zhang', sourceCount: 2, targetCount: 1, kpiCount: 3, lastUpdated: '2026-08-22', description: 'Full Form Quotation (FFQ) experimental rating prototype and quotation latency review.' },
  ...
  { id: 'd7', name: 'INSURANCE ANALYTICS DASHBOARD', technology: 'Tableau', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 1, targetCount: 1, kpiCount: 9, lastUpdated: '2026-09-04', description: 'Distribution sales performance analytics tracking account executive meetings, open opportunities, renewal pipelines, and stage revenues.' },
  ...
  { id: 'd8', name: 'Cross_Sell_dashboardpbip', technology: 'Power BI', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 0, targetCount: 1, kpiCount: 0, lastUpdated: '2026-08-28', description: 'Power BI Project (PBIP) descriptor linking to Cross_Sell_dashboardpbip report artifacts.' },
  { id: 'd9', name: 'New Business (Bottom 25% agents)', technology: 'Power BI', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 6, targetCount: 1, kpiCount: 4, lastUpdated: '2026-08-27', description: 'New policy acquisition and production performance analysis for lower quartile broker support.' },
  { id: 'd10', name: 'Insurance_Analytics_Dashboard', technology: 'Power BI', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 0, targetCount: 1, kpiCount: 0, lastUpdated: '2026-08-29', description: 'Power BI Project (PBIP) descriptor linking to Insurance_Analytics_Dashboard report artifacts.' },
