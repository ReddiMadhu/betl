...
export const allAssets: Asset[] = [
  ...
  { id: 'u3', name: 'Loss Ratio', technology: 'Power BI', businessArea: 'Claims', assetType: 'Dashboard', owner: 'Michael Zhang', sourceCount: 3, targetCount: 1, kpiCount: 8, lastUpdated: '2026-09-03', description: 'Incurred losses compared against earned premiums with quarterly trend modeling.' },
