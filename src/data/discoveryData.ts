...
const allAssets: Asset[] = [
  ...
  { id: 'p1', name: 'New Business Dashboard', technology: 'Tableau', businessArea: 'Policy Administration', assetType: 'Dashboard', owner: 'Diana Lee', sourceCount: 4, targetCount: 2, kpiCount: 7, lastUpdated: '2026-08-18', description: 'New policy acquisition volumes, direct written premiums, and issue turnaround times.' },
  { id: 'p2', name: 'Survival Rate', technology: 'Power BI', businessArea: 'Policy Administration', assetType: 'Dashboard', owner: 'Chris Morgan', sourceCount: 3, targetCount: 1, kpiCount: 5, lastUpdated: '2026-08-22', description: 'Policy retention curves, lapse analysis, and survival rate tracking over renewal terms.' },
