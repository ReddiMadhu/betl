...
const allAssets: Asset[] = [
  ...
  { id: 'c2', name: 'Claims - State Performance', technology: 'Tableau', businessArea: 'Claims', assetType: 'Dashboard', owner: 'James Chen', sourceCount: 3, targetCount: 1, kpiCount: 6, lastUpdated: '2026-07-15', description: 'Geographic and state-by-state claims distribution and severity metrics.' },
  ...
  // ─── Underwriting ───
  { id: 'u1', name: 'Car Insurance Dashboard', technology: 'Tableau', businessArea: 'Underwriting', assetType: 'Dashboard', owner: 'Sarah Mitchell', sourceCount: 3, targetCount: 2, kpiCount: 6, lastUpdated: '2026-08-25', description: 'Auto physical damage and bodily injury claims summary and repair cost analytics.' },
  { id: 'u2', name: 'Motor Insurance Dashboard', technology: 'Tableau', businessArea: 'Underwriting', assetType: 'Dashboard', owner: 'Lisa Wang', sourceCount: 4, targetCount: 2, kpiCount: 7, lastUpdated: '2026-09-04', description: 'Commercial fleet and personal auto underwriting exposure and rating analysis.' },
  { id: 'u3', name: 'Loss Ratio', technology: 'Power BI', businessArea: 'Underwriting', assetType: 'Dashboard', owner: 'Michael Zhang', sourceCount: 4, targetCount: 2, kpiCount: 8, lastUpdated: '2026-09-03', description: 'Incurred losses compared against earned premiums with quarterly trend modeling.' },
  ...
  // ─── Distribution ───
  { id: 'd1', name: 'Claims - Agent Performance', technology: 'Tableau', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Sarah Mitchell', sourceCount: 4, targetCount: 2, kpiCount: 8, dependencies: ['Claims_Extract_Volume'], relatedAssets: ['Cross Sell Dashboard'], lastUpdated: '2026-08-28', description: 'Agent-level claims resolution performance, cycle times, and operational SLA tracking.' },
  { id: 'd2', name: 'Cross Sell Dashboard', technology: 'Tableau', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 3, targetCount: 1, kpiCount: 6, lastUpdated: '2026-09-01', description: 'Policy cross-selling opportunities across commercial, property, and casualty lines.' },
  { id: 'd3', name: 'Jornaya Dashboard PBI', technology: 'Power BI', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 4, targetCount: 1, kpiCount: 6, lastUpdated: '2026-08-29', description: 'Customer journey touchpoint compliance, lead verification, and consumer intent analysis.' },
  { id: 'd4', name: 'Revenue Opportunities', technology: 'Power BI', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 4, targetCount: 2, kpiCount: 7, lastUpdated: '2026-08-29', description: 'Premium growth opportunities, rate change impacts, and pipeline revenue forecast.' },
  { id: 'd5', name: 'Bottom 25% Agents', technology: 'Power BI', businessArea: 'Distribution', assetType: 'Dashboard', owner: 'Amanda Foster', sourceCount: 4, targetCount: 2, kpiCount: 6, lastUpdated: '2026-08-28', description: 'Agent production review identifying lower quartile broker support needs and coaching targets.' },
  ...
  { id: 'p1', name: 'Survival Rate', technology: 'Power BI', businessArea: 'Policy Administration', assetType: 'Dashboard', owner: 'Chris Morgan', sourceCount: 3, targetCount: 1, kpiCount: 5, lastUpdated: '2026-09-04', description: 'Policy retention and survival rate analysis across coverage tiers and customer cohorts.' },
  ...
  // ─── Finance ───
  { id: 'f1', name: 'IT Spend Analysis Sample PBIX', technology: 'Power BI', businessArea: 'Finance', assetType: 'Dashboard', owner: 'Mark Sullivan', sourceCount: 4, targetCount: 1, kpiCount: 6, lastUpdated: '2026-08-25', description: 'Departmental IT operational expenditure, vendor allocation, and budget variance tracking.' },
  { id: 'f2', name: 'Store Sales', technology: 'Power BI', businessArea: 'Finance', assetType: 'Dashboard', owner: 'Jennifer Adams', sourceCount: 4, targetCount: 2, kpiCount: 7, lastUpdated: '2026-08-24', description: 'Retail agency and physical branch location production analysis.' },
  { id: 'f3', name: 'Sales & Returns Sample v3', technology: 'Power BI', businessArea: 'Finance', assetType: 'Dashboard', owner: 'Jennifer Adams', sourceCount: 6, targetCount: 3, kpiCount: 10, lastUpdated: '2026-09-06', description: 'Financial reconciliation of premium billing, returned endorsements, and net revenue.' },

  // ─── Customer ───
  { id: 'cu1', name: 'Benefeciery services_v1', technology: 'Tableau', businessArea: 'Customer', assetType: 'Dashboard', owner: 'Emily Watson', sourceCount: 4, targetCount: 2, kpiCount: 6, lastUpdated: '2026-09-03', description: 'Beneficiary claims processing and customer payout satisfaction indicators.' },
  { id: 'cu2', name: 'Benefeciery_services_Aging_Dashboard', technology: 'Tableau', businessArea: 'Customer', assetType: 'Dashboard', owner: 'Emily Watson', sourceCount: 3, targetCount: 1, kpiCount: 5, lastUpdated: '2026-08-31', description: 'Aging analysis of unresolved beneficiary inquiries and open settlement queues.' },
];
