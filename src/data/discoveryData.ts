...
const allAssets: Asset[] = [
  ...
  { id: 'c6', name: 'Claims_Extract_Volume', technology: 'Alteryx', businessArea: 'Claims', assetType: 'ETL Workflow', owner: 'David Park', sourceCount: 22, targetCount: 16, dependencies: ['Policy_Consolidation_Workflow'], lastUpdated: '2026-09-01', description: 'Extracts and enriches claims data from multiple excel sources, summarising claim volume by quarter and status and analysing claims by product type and aging-litigation risk' },

  // ─── Underwriting ───
  { id: 'u1', name: 'underwriting_scorecard', technology: 'Power BI', businessArea: 'Underwriting', assetType: 'Dashboard', owner: 'Michael Zhang', sourceCount: 4, targetCount: 2, kpiCount: 9, dependencies: ['Underwriting_Workflow'], relatedAssets: ['risk_appetite_monitor'], lastUpdated: '2026-09-03', description: 'Underwriting performance scorecard with hit ratios, quote-to-bind conversion, and average premium analysis.' },
  ...
  { id: 'u3', name: 'risk_appetite_monitor', technology: 'Tableau', businessArea: 'Underwriting', assetType: 'Dashboard', owner: 'Lisa Wang', sourceCount: 5, targetCount: 2, kpiCount: 7, dependencies: ['Underwriting_Workflow'], lastUpdated: '2026-09-04' },
  ...
  { id: 'p4', name: 'Policy_Consolidation_Workflow', technology: 'Alteryx', businessArea: 'Policy Administration', assetType: 'ETL Workflow', owner: 'Rob Taylor', sourceCount: 8, targetCount: 5, lastUpdated: '2026-09-05', description: 'Consolidates policy, claims and payment data from multiple sources, enriching it with reference datasets' },
  ...
  { id: 'f4', name: 'Finance_ETL', technology: 'Alteryx', businessArea: 'Finance', assetType: 'ETL Workflow', owner: 'Carlos Rivera', sourceCount: 9, targetCount: 4, lastUpdated: '2026-09-05', description: 'Calculates the dates using predefined formulas and aggregate volumes by industry, type Service location and month-end date.' },
  ...
  { id: 'cu4', name: 'Customer_Thursday_Metrics', technology: 'Alteryx', businessArea: 'Customer', assetType: 'ETL Workflow', owner: 'Megan Scott', sourceCount: 5, targetCount: 3, lastUpdated: '2026-09-02' , description: 'Consolidates and automate the generation of a specific weekly summary, customer report, enabling recurring analysis of Thursday-related customer metrics' },
