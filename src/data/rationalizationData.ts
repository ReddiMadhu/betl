...
export const recommendations: Recommendation[] = [
  ...
  },
  {
    ...
    businessArea: 'Claims',
    overlapPct: 65,
    assets: [asset('claims_performance', 'Tableau'), asset('claims_operations_dashboard', 'Tableau')],
    ...
    action: 'Consolidate into Tableau claims_operations_dashboard. Port trend analysis views.',
  ...
  },
  {
    ...
    overlapPct: 54,
    assets: [asset('loss_ratio_analysis', 'Power BI'), asset('financial_overview', 'Power BI')],
    rationale: 'Loss ratio analysis is a subset of the financial overview. All 5 KPIs in the loss ratio report exist in the Power BI dashboard.',
    action: 'Retire loss_ratio_analysis. Ensure loss-ratio tab in Power BI financial_overview.',
  ...
  },
  {
    ...
    overlapPct: 61,
    assets: [asset('nps_survey_analysis', 'Power BI'), asset('customer_retention_dashboard', 'Power BI')],
  ...
  },
  {
    ...
    overlapPct: 52,
    assets: [asset('policy_book_analysis', 'Tableau'), asset('policy_lifecycle_dashboard', 'Tableau')],
    ...
    action: 'Add book analysis views to the Tableau policy lifecycle dashboard.',
  ...
  //   businessArea: 'Claims',
  //   overlapPct: 68,
  //   assets: [asset('Claims_Extract_Volume', 'Alteryx'), asset('claims_processing', 'Python')],
  //   rationale: 'Both pipelines extract from the same policy core system. Claims_Extract_Volume and claims_processing share common transformation steps and 2/4 source files.',
  //   action: 'Consolidate into a single Alteryx workflow with claims_processing as a sub-module.',
  //   tags: ['Shared Sources'],
  ...
  //   commonKpis: ['Extract Row Count', 'Load Latency (s)', 'Transformation Steps'],
  //   commonTables: ['claims_diary_notes', 'claims_policy'],
  //   mergeTarget: 'claims_processing',
  // },
  {
    id: 'em2',
    category: 'etl-merge',
  ...
  //   businessArea: 'Underwriting',
  //   overlapPct: 48,
  //   assets: [asset('underwriting_risk_etl', 'Alteryx'), asset('rating_bureau_integration', 'Alteryx')],
  //   rationale: 'Rating bureau pipeline re-extracts data already available in the risk ETL output. Shared source overlap of 48%.',
  //   action: 'Consolidate rating bureau pipeline directly into underwriting_risk_etl.',
  ...
  //   businessArea: 'Customer',
  //   overlapPct: 42,
  //   assets: [asset('customer_data_integration', 'Python'), asset('actuarial_data_pipeline', 'Python')],
  //   rationale: 'Actuarial pipeline extracts customer demographics already consolidated by the customer data integration script. Redundant extraction from CRM system.',
  ...
  /* ── ETL Retire ── */
  {
    ...
    rationale: 'This workflow, exhibit identical source, target, transformation, schema, grain, DAG and frequency overlap, with Claims_Extract_Volume. The shaded logic includes identical formulas, joints, and summarisation operations indicating redundant functionality',
  ...
  },
  {
    ...
    rationale: 'This produces no production deliverables and terminate exclusively in inspection. Sales likely represents an ad hoc data investigation or unfinished deployment asset as the linked YXMC file is not available.',
  ...
  },
  {
    id: 'bk2',
    category: 'bi-keep',
    title: 'Keep Jornaya Customer Analytics',
    businessArea: 'Customer',
    assets: [asset('Jornaya Dashboard PBI', 'Power BI')],
    rationale: 'Customer journey analytics with lead verification scores and consumer engagement tracking. 32 active users.',
    action: 'Retain. Primary customer intelligence dashboard.',
    tags: ['Unique', 'High Usage'],
  },
  {
    id: 'bk3',
    category: 'bi-keep',
    title: 'Keep Sales & Returns Analysis',
    businessArea: 'Policy Administration',
    assets: [asset('Sales & Returns Sample v3', 'Power BI')],
    rationale: 'End-to-end policy distribution visibility with 8 KPIs. Primary operational dashboard for administration team.',
    action: 'Retain as-is.',
  ...
  },
  {
    id: 'bk4',
    category: 'bi-keep',
    title: 'Keep FFQ Scorecard',
    businessArea: 'Underwriting',
    assets: [asset('FFQ_Test', 'Power BI')],
    rationale: 'Financial feasibility questionnaire and risk appetite scorecard with 5 KPIs.',
    action: 'Retain as-is.',
    tags: ['Daily Use'],
  },
  {
    id: 'bk5',
    category: 'bi-keep',
    title: 'Keep Cross Sell Dashboard',
    businessArea: 'Distribution',
    assets: [asset('Cross Sell Dashboard', 'Tableau')],
    rationale: 'Primary agent/broker multi-line product tracking with 8 KPIs. Distribution team operational dashboard.',
    action: 'Retain. Plan modernization to Power BI.',
  ...
  },
  {
    ...
    rationale: 'Executive summary of claims operations including open/closed ratios, cycle times, and regional loss breakdown.',
    action: 'Retain as core claims operational dashboard.',
    tags: ['Critical', 'Specialized'],
  },
  {
    id: 'bk7',
    category: 'bi-keep',
    title: 'Keep P&C Claims Dossier',
    businessArea: 'Claims',
    assets: [asset('P&C Claims Dashboard_v3', 'MicroStrategy')],
    rationale: 'Core enterprise dossier with 66 metrics, 40 attributes, and advanced fraud/litigation indicators.',
    action: 'Retain. Prepare for automated migration.',
    tags: ['Unique', 'Enterprise'],
  },
  {
    id: 'bk8',
    category: 'bi-keep',
