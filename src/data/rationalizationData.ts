...
export const recommendations: Recommendation[] = [
  ...
  },
  {
    ...
    businessArea: 'Underwriting',
    overlapPct: 48,
    assets: [asset('Underwriting_Workflow', 'Alteryx'), asset('quote_generation_pipeline', 'Python')],
  ...
  /* ── BI Retire ── */
  {
    ...
    rationale: 'ORPHAN CASCADE: Not viewed by any user in the past 194 days. The associated Underwriting_Workflow partially feeds this dashboard — but also feeds 2 other active dashboards, so the ETL is retained.',
