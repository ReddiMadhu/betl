...
/**
 * Official Amazon Web Services (AWS) SVG logo with theme-reactive text color and signature #FF9900 smile arrow.
 */
export function AwsLogo({ className = 'w-6 h-5', ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 20 128 88"
      fill="none"
      ...
      {...props}
    >
      {/* AWS Lettermark - adapts to current theme text color */}
      <path
        fill="currentColor"
...
/**
 * Official Microsoft Azure SVG icon with official gradient definitions and geometry.
 */
export function AzureLogo({ className = 'w-5 h-5', ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 128 128"
      fill="none"
